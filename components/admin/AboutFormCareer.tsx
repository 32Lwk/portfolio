...
export function AboutFormCareer({ items, onChange }: AboutFormCareerProps) {
  const fileRefs = useRef<Record<string, HTMLInputElement | null>>({});

  const updateItem = (index: number, item: Partial<CareerItem>) => {
    const next = [...items];
